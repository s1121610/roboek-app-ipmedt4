...
const invoer = (props) => {
  return (
    <section className="woordzoeker__invoer">
      ...
      <input type="text" name="woord" id="woord" placeholder="Voer hier je woord in" onKeyPress={props.functie}/>
      <button  type="button" onClick={() => props.functie("Enter")}> zoek </button>
